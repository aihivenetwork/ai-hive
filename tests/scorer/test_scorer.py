...
from aihive.scorer import Score, Scorer, Target, accuracy, includes, scorer
from aihive.scorer._scorer import scorer_create
...
def test_score_package_name():
    ...
    from aihivepackage import simple_score
