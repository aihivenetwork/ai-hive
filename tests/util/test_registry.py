...
from aihive.scorer import Metric, Score, metric
from aihive.solver import Plan, Solver, solver, use_tools
from aihive.tool import Tool, bash
...
def test_registry_namespaces() -> None:
    ...
    # confirm that aihive builtins have their namespace auto-appended
