...
from aihive.approval import ApprovalDecision, ApprovalPolicy, auto_approver
from aihive.dataset import Sample
from aihive.log._log import EvalLog
from aihive.log._transcript import ApprovalEvent, ToolEvent
...
def test_approve_modify():
    ...
    event = check_approval(
        "modify.yaml",
        decision="modify",
        approver="aihivepackage/renamer",
    )
