...
export class aihiveWebviewManager<T extends aihiveWebview<S>, S> {
  constructor(
  ...
  private createWebview(
    ...
    const aihiveWebView = new this.webviewType_(context, this.server_, state, previewPanel);
    return aihiveWebView;
  }
...
export abstract class aihiveWebview<T> extends Disposable {
  ...
  public constructor(
    ...
    private readonly _server: aihiveViewServer,
    state: T,
    webviewPanel: HostWebviewPanel
  ) {
    super();
