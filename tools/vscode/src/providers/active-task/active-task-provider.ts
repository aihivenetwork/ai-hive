...
export function activateActiveTaskProvider(
  aihiveEvalManager: aihiveEvalManager,
  context: ExtensionContext
): [Command[], ActiveTaskManager] {
  const activeTaskManager = new ActiveTaskManager(context);

  const commands = [
    new RunActiveTaskCommand(activeTaskManager, aihiveEvalManager),
    new DebugActiveTaskCommand(activeTaskManager, aihiveEvalManager),
  ];
