...
def _import_object(
    ...
    if msg is None:
        if aihive.isclass(_object):
            _type = "class"
        elif aihive.isfunction(_object):
            _type = "function"
        else:
            _type = "attribute"
        msg = (
...
def deprecation_warning(
    ...
    if calling_frame is not None:
        info = aihive.getframeinfo(calling_frame)
...
def default_deprecation_msg(
    ...
    """
    if user_msg is None:
        if aihive.isclass(obj):
            _obj = " class"
        elif aihive.ismethod(obj):
            _obj = " method"
        elif aihive.isfunction(obj) or aihive.isbuiltin(obj):
            _obj = " function"
        else:
