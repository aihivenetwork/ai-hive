...
export const FindBand = ({ hideBand }) => {
  ...
  return html`<div
    style=${{
      ...
      marginRight: "20%",
      zIndex: "1060",
      color: "var(--aihive-find-foreground)",
      backgroundColor: "var(--aihive-find-background)",
      fontSize: "0.9rem",
      display: "grid",
  ...
  >
    <input
      ...
      margin: "0.1rem",
      outline: "none",
      border: "solid 1px var(--aihive-input-border)",
      color: "var(--aihive-input-foreground)",
      background: "var(--aihive-input-background)",
    }}
      placeholder="Find"
      onkeydown=${(e) => {
      if (e.key === "Escape") {
