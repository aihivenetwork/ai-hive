            ...
            if cleanup:
                ...
                for project in shutdown_projects:
                    ...
                    table.add_row(
                        ...
                        f"[blue]aihive sandbox cleanup docker {project.name}[/blue]",
                    )
                print(table)
                print(
                    "\nCleanup all environments with: [blue]aihive sandbox cleanup docker[/blue]\n"
                )
