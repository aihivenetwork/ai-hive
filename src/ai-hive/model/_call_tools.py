...
from aihive._util.text import truncate_string_to_bytes
from aihive.model._trace import trace_tool_mesage
from aihive.tool import Tool, ToolCall, ToolError, ToolInfo
from aihive.tool._tool import (
    ToolApprovalError,
    ToolParsingError,
)
from aihive.tool._tool_call import ToolCallContent, ToolCallError
from aihive.tool._tool_def import ToolDef, tool_defs
from aihive.tool._tool_info import parse_docstring
from aihive.tool._tool_params import ToolParams
from aihive.util import OutputLimitExceededError
...
async def call_tool(tools: list[ToolDef], message: str, call: ToolCall) -> Any:
    ...
    from aihive.approval._apply import apply_tool_approval
...
def tool_params(input: dict[str, Any], func: Callable[..., Any]) -> dict[str, Any]:
    ...
    signature = aihive.signature(func)
    type_hints = get_type_hints(func)
    docstring = aihive.getdoc(func)
