...
from aihive._util.constants import DEFAULT_MAX_TOKENS
    ...
    def hf_chat(self, messages: list[ChatMessage], tools: list[ToolInfo]) -> str:
        ...
        if len(tools) > 0:
            ...
            if "mistral" in self.model_name.lower():
                ...
                hf_messages = aihivetools_to_string(hf_messages)
...
def aihivetools_to_string(messages: list[ChatMessage]) -> list[ChatMessage]:
