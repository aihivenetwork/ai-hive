...
from aihive._util.constants import BASE_64_DATA_REMOVED, DEFAULT_MAX_RETRIES
from aihive._util.content import Content, ContentText
...
from aihive._util.url import data_uri_mime_type, data_uri_to_base64, is_data_uri
...
async def resolve_chat_input(
    ...
    # collapse user messages (as aihive 'tool' messages become Claude 'user' messages)
