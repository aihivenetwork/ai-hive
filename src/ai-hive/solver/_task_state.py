...
from aihive.dataset._dataset import Sample
...
from aihive.model._call_tools import tools_info
from aihive.model._model import sample_total_tokens
from aihive.tool import Tool, ToolChoice
from aihive.tool._tool_def import ToolDef
from aihive.util._store import Store, store_jsonable
...
class TaskState:
    ...
    def message_limit(self, messages: int | None) -> None:
        ...
        from aihive.log._samples import set_active_sample_message_limit
    ...
    def token_limit(self, tokens: int | None) -> None:
        ...
        from aihive.log._samples import set_active_sample_token_limit
    ...
    def completed(self) -> bool:
        ...
        # update messages
        from aihive.log._samples import set_active_sample_total_messages
        from aihive.log._transcript import SampleLimitEvent, transcript
