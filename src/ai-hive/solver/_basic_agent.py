...
from aihive.model._cache import CachePolicy
from aihive.model._call_tools import call_tools
from aihive.model._chat_message import ChatMessageTool, ChatMessageUser
from aihive.model._model import get_model
from aihive.scorer._metric import Score, ValueToFloat, value_to_float
from aihive.scorer._score import score
from aihive.solver._chain import chain
from aihive.tool._tool import Tool, ToolResult, tool
        ...
        async def solve(state: TaskState, generate: Generate) -> TaskState:
            ...
            while not state.completed:
                ...
                if state.output.stop_reason == "model_length":
                    from aihive.log._transcript import transcript
