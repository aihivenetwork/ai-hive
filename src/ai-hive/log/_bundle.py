...
def bundle_log_dir(
    ...
    Args:
        ...
        output_dir: (str | None): The directory to place bundled output. If no directory
            is specified, the env variable `aihive_VIEW_BUNDLE_OUTPUT_DIR` will be used.
    ...
    log_dir = log_dir if log_dir else os.getenv("aihive_LOG_DIR", "./logs")

    # resolve the output directory
    output_dir = (
        output_dir if output_dir else os.getenv("aihive_VIEW_BUNDLE_OUTPUT_DIR", "")
    )
    if output_dir == "":
