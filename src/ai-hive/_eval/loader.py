...
from aihive._eval.task.util import task_file, task_run_dir
from aihive._util.decorator import parse_decorators
from aihive._util.error import PrerequisiteError
from aihive._util.logger import warn_once
from aihive._util.path import chdir_python
...
from aihive.model import Model, ModelName
from aihive.solver._solver import Solver, SolverSpec
from aihive.util import SandboxEnvironmentSpec, SandboxEnvironmentType
from aihive.util._sandbox.environment import resolve_sandbox_environment
...
def load_module(
    ...
    if module_path.suffix == ".py":
        ...
        try:
            from aihive._util.notebook import NotebookLoader
        except ImportError:
            return None
