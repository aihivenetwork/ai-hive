...
from aihive._display.core.textual import textual_enable_mouse_support
from aihive._util.html import as_html_id
from aihive.log._samples import active_samples
from aihive.log._transcript import InputEvent, transcript
...
from .theme import aihivedark, aihivelight
...
class TaskScreenApp(App[TR]):
    ...
    def on_mount(self) -> None:
        ...
        self.register_theme(aihivedark)
        self.register_theme(aihivelight)
        self.theme = "aihive-dark"
