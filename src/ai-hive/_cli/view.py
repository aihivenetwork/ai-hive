...
from aihive._view.view import view
...
def start(
    ...
    **common: Unpack[CommonOptions],
    ...
    aihive_VIEW_AUTHORIZATION_TOKEN = "aihive_VIEW_AUTHORIZATION_TOKEN"
    authorization = os.environ.get(aihive_VIEW_AUTHORIZATION_TOKEN, None)
    if authorization:
        del os.environ[aihive_VIEW_AUTHORIZATION_TOKEN]
        os.unsetenv(aihive_VIEW_AUTHORIZATION_TOKEN)
