...
from aihive._util._async import is_callable_coroutine
from aihive._util.content import Content
from aihive.util._store import Store, dict_jsonable, init_subtask_store
    ...
    def create_subtask_wrapper(func: Subtask, name: str | None = None) -> Subtask:
        ...
        async def run_subtask(*args: Any, **kwargs: Any) -> RT:
            ...
            if input is not None:
                ...
                log_input = {}
                if len(args) > 0:
                    params = list(aihive.signature(func).parameters.keys())
