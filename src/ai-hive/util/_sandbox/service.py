...
SERVICES_DIR = "/tmp/aihive-sandbox-services"
...
class SandboxService:
    ...
    for calling back into the main aihive process.
    ...
    ```python
    import sys
    sys.path.append("/tmp/aihive-sandbox-services/foo")
    import foo
    ```
    ...
    spec = importlib.util.spec_from_file_location(
        "foo", "/tmp/aihive-sandbox-services/foo/foo.py"
    )
